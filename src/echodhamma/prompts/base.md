...
4. **Podcast Description (Sinhala)**:
   ...
   * **Strict Objectivity**:
      * Do NOT add concluding blessings, aspirational statements (e.g., "May this lead to Nirvana")
      * Do NOT include speaker's/Thero's name.
      * Do NOT include advice not explicitly stated in the video.
      * Summarize only the factual points covered by the Thero.
